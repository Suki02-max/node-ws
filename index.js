...
const UUID = process.env.UUID || '23fa374a-6838-4562-b6e3-973200bf68e9'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'songjiaxian''song'j';            // 获取const NAME = process.env.NAME || '';                       // 节点名称
